...
{
    public partial class ConfiguracionPanel : UserControl
    {
        ...
        private void SetupUI()
        {
            ...
            // Centrar la tarjeta en el panel
            pnlPrincipal.SizeChanged += (s, e) =>
            {
                card.Left = (pnlPrincipal.Width - card.Width) / 2;
                card.Top = (pnlPrincipal.Height - card.Height) / 2;
            };
